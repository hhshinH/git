...
{
	partial class UserInformation_Project
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserInformation_Project));
			...
			this.ribbonControl1.Size = new System.Drawing.Size(923, 147);
			// 
			// barButtonItem1
			// 
			this.barButtonItem1.Caption = "어린이 관리";
			...
			// barButtonItem2
			// 
			this.barButtonItem2.Caption = "성생님 관리";
			...
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "유아원 관리";
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "등하원 관리";
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "일정표";
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "투약 관리";
			...
			this.ribbonPage1.Text = "통합 관리";
			// 
			// ribbonPageGroup1
			// 
			this.ribbonPageGroup1.ImageUri.Uri = "AlignVerticalRight";
			...
			this.Name = "UserInformation_Project";
			this.Ribbon = this.ribbonControl1;
			this.Text = "UserInformation_Project";
