...
namespace UserInformation_Project.Control.FROM
{
	public partial class GridViewTeach : DevExpress.XtraEditors.XtraUserControl
	{
		...
		{
			this.gridView1.Columns["TEACH_NAME"].Caption = "이름";
			this.gridView1.Columns["TEACH_NAME"].OptionsColumn.ReadOnly = true;
			this.gridView1.Columns["TEACH_BIRTH"].Caption = "생년월일";
			this.gridView1.Columns["TEACH_BIRTH"].OptionsColumn.ReadOnly = true;
			this.gridView1.Columns["TEACH_KEY"].Visible = false;
